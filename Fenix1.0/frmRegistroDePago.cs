...
namespace frmABMME
{
    public partial class frmRegistroDePago : Form
    {
        ...
        private void btnPagar_Click(object sender, EventArgs e)
        {
            ...
            //              //METODO QUE ME TRAE EL ULTIMO ID DE FACTURA     

            //    foreach(clsTurno turn in sobreTurnosReporte)
            //    {
            //        recibo.IdFactura = reposFac.ultimoID() + 1; 
            //        recibo.idTurno = turn.Id;
            //        recibo.fecha = turn.Fecha;
        ...
        private void pnlTurno_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            //asdsaasdfasdfasdfasdgasdgsdasdasdasdasd
        }

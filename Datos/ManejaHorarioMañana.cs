...
namespace Datos
{
    public class ManejaHorarioMañana : iMetodos
    {
        ...
        public void Alta(IEntidad entidad)
        {
            ...
            try
            {
                aux = manager.consultar("select * from horarioMañana where idmedico=" + ent.IdMedico);

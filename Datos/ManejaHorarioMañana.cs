    ...
    public class ManejaHorarioMañana : iMetodos
    {
        ...
        public void Alta(IEntidad entidad)
        {
            ...
            try
            {
                ...
                //manager.ejecutar("Insert into horarioMañana(idmedico,lunesentrada,lunessalida,martesentrada,martessalida,miercolesentrada,miercolessalida,juevesentrada,juevessalida,viernesentrada,viernessalida,sabadoentrada,sabadosalida,domingoentrada,domingosalida) values(" + ent.IdMedico + ", convert(datetime,'"+ ent.LunesEntrada +"',5) ,convert(datetime,'"+ ent.LunesSalida +"',5),convert(datetime,'"+ ent.MartesEntrada +"',5), convert(datetime,'"+ ent.MartesSalida +"',5), convert(datetime,'"+ ent.MiercolesEntrada +"',5), convert(datetime,'"+ ent.MiercolesSalida +"',5), convert(datetime,'"+ ent.JuevesEntrada +"',5), convert(datetime,'"+ ent.JuevesSalida +"',5), convert(datetime,'"+ ent.ViernesEntrada +"',5), convert(datetime,'"+ ent.ViernesSalida +"',5), convert(datetime,'"+ ent.SabadoEntrada +"',5), convert(datetime,'"+ ent.SabadoSalida +"',5), convert(datetime,'"+ ent.DomingoEntrada +"',5), convert(datetime,'"+ ent.DomingoSalida +"',5)" + ");SELECT @@identity;");
                //manager.ejecutar("Insert into horarioMañana(idmedico,lunesentrada,lunessalida,martesentrada,martessalida,miercolesentrada,miercolessalida,juevesentrada,juevessalida,viernesentrada,viernessalida,sabadoentrada,sabadosalida,domingoentrada,domingosalida) values(" + ent.IdMedico + ", convert(datetime,"+ ent.LunesEntrada +",5) ,convert(datetime,"+ ent.LunesSalida +",5), convert(datetime,"+ ent.MartesEntrada +",5), convert(datetime,"+ ent.MartesSalida +",5), convert(datetime,"+ ent.MiercolesEntrada +",5), convert(datetime,"+ ent.MiercolesSalida +",5), convert(datetime,"+ ent.JuevesEntrada +",5), convert(datetime,"+ ent.JuevesSalida +",5), convert(datetime,"+ ent.ViernesEntrada +",5), convert(datetime,"+ ent.ViernesSalida +",5), convert(datetime,"+ ent.SabadoEntrada +",5), convert(datetime,"+ ent.SabadoSalida +",5), convert(datetime,"+ ent.DomingoEntrada +",5), convert(datetime,"+ ent.DomingoSalida +",5)" + ");SELECT @@identity;");
